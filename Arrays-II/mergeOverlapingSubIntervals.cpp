...
// INTUTION : The intuition of this approach is pretty straightforward. 
...
// So, we can conclude that every interval is roughly visited twice(roughly, once for checking or skipping and once for merging). 
